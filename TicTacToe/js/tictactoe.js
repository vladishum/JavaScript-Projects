...
function placeXOrO(squareNumber) {
    ...
    if(!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        //This calls a function toc check for any win conditions.
        checkWinConditions();
    ...
    function computersTurn() {
        ...
        let pickASquare;
        //This condition allows our while loop to keep trying ia a square is selected already.
        while(!success) {
            //A random between 0 an 8 is selected 
...
function checkWinConditions() {
    ...
    //This condition checks for tie. If none of the abpve conditions register
...
//This function makes our body element temporarily
...
//This function takes a string parametar of the path you set earlier for
//placement sound ('./media/place.mp3')
function audio(audioURL) {
    //We create a new audio object and we pass the path as a parametar.
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    let x1 = coordX1,
        ...
        x = x1,
        //This variable stores temporary y axis data we update in our animatio loop.
        y = y1;
        ...
        function clear() {
            //This line starts our anumation loop.
