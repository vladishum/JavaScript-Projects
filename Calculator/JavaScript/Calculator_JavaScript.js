...
const Calculator = {
    ...
    //this will hold the operator, we set it to null foe now
    operator: null,
};
...
function Input_Digit(digit) {
    ...
    //Disaply_Value to the key taht was clicked.
...
function Handle_Operator(Next_Operator) {
    ...
    //Calculator.First_Operand if it doesn't already exists
    ...
    } else if(operator) {//checks if sn operator already exists
...
keys.addEventListener('click', (event) => { 
    ...
    //this ensures that AC clears the number from teh Calculator
